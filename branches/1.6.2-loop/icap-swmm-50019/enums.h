...
enum SysFlowType {
     ...
     SYS_FLOODING_NUM_NODES,           // number of nodes flooded
...
enum  CompatibilityType {
 ...
 enum InputSectionType {
      s_TITLE,        s_OPTION,       s_EXTENDED_OPTION,
      s_FILE,         s_RAINGAGE,
      ...
      s_GATE,       s_XSECTION,     s_TRANSECT,     s_LOSSES,
 ...
 enum InputOptionType {
      ...
      HPG_PATH,          PUMPING_RATE,
	  DAYS_BEFORE_PUMPING, PUMPING_THRESHOLD};
