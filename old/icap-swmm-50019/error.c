...
#define ERR901 "\n  ERROR 901: invalid path to HPG folder (%s) "
#define ERR902 "\n  ERROR 902: ICAP network error (%s) "
#define ERR903 "\n  ERROR 903: HPG loading error (%s) "
...
char* ErrorMsgs[] =
    { "",     ERR101, ERR103, ERR105, ERR107, ERR108, ERR109, ERR110, ERR111,
      ...
      ERR402, ERR403, ERR405, ERR901, ERR902, ERR903};
