...
#define FMT08 \
  "\n  ILLINOIS CONVEYANCE ANALYSIS PROGRAM - VERSION 1.6"         //(5.0.013 - LR)
#define FMT09 \
  "\n  --------------------------------------------------------------"
#define FMT10 "\n"
...
#define  w_HPG_PATH          "HPG_PATH"
#define  w_PUMPING_RATE      "PUMPING_RATE"
#define  w_DAYS_BEFORE_PUMPING "DAYS_BEFORE_PUMPING"
#define  w_PUMPING_THRESHOLD "PUMPING_THRESHOLD"
...
#define  w_MGAL              "Mgal"                                            //(5.0.012 - LR)
#define  w_MLTRS             "Mltrs"                                           //(5.0.012 - LR)

// Ponded Volume Units                                                         //(5.0.012 - LR)
#define  w_ACRE_IN           "acre-in"                                         //(5.0.012 - LR)
#define  w_HA_MM             "ha-mm"                                           //(5.0.012 - LR)
...
#define  ws_EXTENDED_OPTION  "[EXTENDED_OPTION"
#define  ws_FILE             "[FILE"
