...
EXTERN char
                  ...
                  HPGPath[MAXFNAME+1];      // ICAP HPG path
...
EXTERN double
				  ...
				  PumpingRate,				// ICAP pumping rate
				  DaysBeforePumping,		// ICAP "days before pumping"
				  PumpingThreshold;			// ICAP pumping threshold
...
EXTERN TGate*     Gate;                     // Array of outlet device links
