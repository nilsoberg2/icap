...
static double getExcessInfil(double* x, double tStep);
...
//
{
    ...
    double xInfil;                     // excess infiltration
...
double getExcessInfil(double* x, double tStep)
//
...
//
{
    ...
    xInfil = Infil - availUpperVol/FracPerv/tStep;                             //(5.0.010 - LR)
...
//
{
    ...
    return (t1 - t2 + t3) / UCF(GWFLOW);                                       //(5.0.010 - LR)
}
